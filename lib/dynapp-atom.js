...
`
  ...
  async upload () {
    ...
    try {
      ...
      await sync.upload();
      atom.notifications.addInfo('Files are uploaded', {});
    } catch (e) {
      atom.notifications.addError('Upload failed. Check logs for more info.');
    }
  },
  ...
  async download() {
    ...
    try {
      ...
      atom.notifications.addError('Project download failed. Check logs for more info.');
    }
  }
};
